...
class LSTMModel(nn.Module):
    ...
    def __init__(self, args, num_classes, device=None):
        ...
        self.lstm = nn.LSTM(input_dim * num_nodes, rnn_units, num_rnn_layers, batch_first=True)
    ...
    def forward(self, inputs, seq_lengths):
        ...
        output, _ = self.lstm(inputs,
                              (initial_hidden_state, initial_cell_state))  # (batch_size, max_seq_len, rnn_units)
