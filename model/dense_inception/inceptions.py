...
class Inception2d(nn.Module):
    ...
    def __init__(self, in_channels, pool_features):
        ...
        self.branchC_2 = BasicConv2d(pool_features,
                                     pool_features,
                                     False,
                                     kernel_size=(21, 1),
                                     stride=1,
...
class Inception(nn.Module):
    ...
    def __init__(self, in_channels, pool_features, filter_size, pool_size):
        ...
        self.branchA = BasicConv2d(in_channels,
                                   pool_features,
                                   False,
        ...
        self.branchB_1 = BasicConv2d(in_channels,
                                     pool_features,
                                     False,
        ...
        self.branchB_2 = BasicConv2d(pool_features,
                                     pool_features,
                                     False,
                                     kernel_size=(filter_size[1], 1),
                                     stride=1,
        ...
        self.branchB_3 = BasicConv2d(pool_features,
                                     pool_features,
                                     False,
                                     kernel_size=(filter_size[1], 1),
                                     stride=1,
        ...
        self.branchC_1 = BasicConv2d(in_channels,
                                     pool_features,
                                     False,
...
class Inception3(nn.Module):
    ...
    def __init__(self, in_channels, pool_features, filter_size, pool_size):
        ...
        self.branchA_1 = BasicConv2d(in_channels,
                                     pool_features,
                                     False,
                                     kernel_size=(filter_size[0], 1),
                                     stride=1,
        ...
        self.branchA_2 = BasicConv2d(pool_features,
                                     pool_features,
                                     False,
                                     kernel_size=(filter_size[0], 1),
                                     stride=1,
